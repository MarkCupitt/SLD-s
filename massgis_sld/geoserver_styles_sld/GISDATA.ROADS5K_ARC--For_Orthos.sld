            ...
            <FeatureTypeStyle>
                ...
                <Rule>
                    ...
                    <LineSymbolizer>
                        <Stroke>
                            <CssParameter name="stroke">
                                <Literal xmlns="http://www.opengis.net/ogc">#FFFFC6</Literal>
                            </CssParameter>																						
                        </Stroke>
                    </LineSymbolizer>
                </Rule>
                ...
                <Rule>
                    ...
                    <LineSymbolizer>
                        <Stroke>
                            <CssParameter name="stroke">#FFB500</CssParameter>
                        </Stroke>
                    </LineSymbolizer>
                </Rule>
                <Rule>
                    ...
                    <LineSymbolizer>
                        <Stroke>
                            <CssParameter name="stroke">#FFDE8C</CssParameter>
                        </Stroke>
                    </LineSymbolizer>
                </Rule>
                <Rule>
                    ...
                    <LineSymbolizer>
                        <Stroke>
                            <CssParameter name="stroke">
                                <Literal xmlns="http://www.opengis.net/ogc">#FFD600</Literal>
                            </CssParameter>	
                            <CssParameter name="stroke-dasharray">5 3</CssParameter>																																							
                        </Stroke>
                    </LineSymbolizer>
                ...
                <Rule>
                    ...
                    <LineSymbolizer>
                        <Stroke>
                            <CssParameter name="stroke">
                                <Literal xmlns="http://www.opengis.net/ogc">#FFDE8C</Literal>
                            </CssParameter>	
                            <CssParameter name="stroke-dasharray">5 3</CssParameter>																																	
                        </Stroke>
                    </LineSymbolizer>
